...
@Component({
  selector: 'app-notification-participate-event',
  templateUrl: './notification-participate-event.component.html',
  styleUrls: ['./notification-participate-event.component.scss'],
})
export class NotificationParticipateEventComponent implements OnInit {
  @Input() data: any = {};
  ...
  ngOnInit(): void {
    this.news = this.data?.participate?.news;
    if (this.data?.author) {

...
@Component({
  selector: 'app-notification-following',
  templateUrl: './notification-following.component.html',
  styleUrls: ['./notification-following.component.scss'],
})
export class NotificationFollowingComponent implements OnInit {

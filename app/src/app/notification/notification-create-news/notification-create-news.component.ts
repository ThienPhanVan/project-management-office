...
@Component({
  selector: 'app-notification-create-news',
  templateUrl: './notification-create-news.component.html',
  styleUrls: ['./notification-create-news.component.scss'],
})
export class NotificationCreateNewsComponent implements OnInit {
  @Input() data: any = {};

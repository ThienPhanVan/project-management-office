...
@Component({
  selector: 'app-notification-mention-comment',
  templateUrl: './notification-mention-comment.component.html',
  styleUrls: ['./notification-mention-comment.component.scss'],
})
export class NotificationMentionCommentComponent implements OnInit {
  @Input() data: any = {};
  ...
  setResult(ev: any, data: any) {
    ...
    this.actionSheet.emit({ event, data, action: 'mention_news' });
  }

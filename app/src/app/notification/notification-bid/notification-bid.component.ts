...
@Component({
  selector: 'app-notification-bid',
  templateUrl: './notification-bid.component.html',
  styleUrls: ['./notification-bid.component.scss'],
})
export class NotificationBidComponent implements OnInit {
  @Input() data: any = {};
  ...
  setResult(ev: any, data: any) {
    ...
    this.actionSheet.emit({ event, data, action: 'bib' });
  }

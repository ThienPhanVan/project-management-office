...
@Component({
  selector: 'app-notification-mention-news',
  templateUrl: './notification-mention-news.component.html',
  styleUrls: ['./notification-mention-news.component.scss'],
})
export class NotificationMentionNewsComponent implements OnInit {
  @Input() data: any = {};

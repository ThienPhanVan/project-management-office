...
@Component({
  selector: 'app-notification-assignee-issue',
  templateUrl: './notification-assignee-issue.component.html',
  styleUrls: ['./notification-assignee-issue.component.scss'],
})
export class NotificationAssigneeIssueComponent implements OnInit {
  @Input() data: any = {};

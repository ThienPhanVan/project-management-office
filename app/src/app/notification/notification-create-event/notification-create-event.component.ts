...
@Component({
  selector: 'app-notification-create-event',
  templateUrl: './notification-create-event.component.html',
  styleUrls: ['./notification-create-event.component.scss'],
})
export class NotificationCreateEventComponent implements OnInit {
  @Input() data: any = {};

...
@Component({
  selector: 'app-notification-org-create-news',
  templateUrl: './notification-org-create-news.component.html',
  styleUrls: ['./notification-org-create-news.component.scss'],
})
export class NotificationOrgCreateNewsComponent implements OnInit {
  @Input() data: any = {};
  ...
  setResult(ev: any, data: any) {
    ...
    this.actionSheet.emit({ event, data, action: 'create_news' });
  }

...
@Component({
  selector: 'app-notification-org-create-opportunity',
  templateUrl: './notification-org-create-opportunity.component.html',
  styleUrls: ['./notification-org-create-opportunity.component.scss'],
})
export class NotificationOrgCreateOpportunityComponent implements OnInit {
  @Input() data: any = {};
  ...
  private _actionSheetButtonRead = [
    // {
  ...
  public get actionSheetButtonRead() {
    return this._actionSheetButtonRead;
  }
  public set actionSheetButtonRead(value) {
    this._actionSheetButtonRead = value;
  }
  ...
  setResult(ev: any, data: any) {
    ...
    this.actionSheet.emit({ event, data, action: 'create_opportunity' });
  }

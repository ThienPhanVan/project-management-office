...
@Component({
  selector: 'app-notification-create-opportunity',
  templateUrl: './notification-create-opportunity.component.html',
  styleUrls: ['./notification-create-opportunity.component.scss'],
})
export class NotificationCreateOpportunityComponent implements OnInit {
  @Input() data: any = {};

...
@Component({
  selector: 'app-notification-comment-news',
  templateUrl: './notification-comment-news.component.html',
  styleUrls: ['./notification-comment-news.component.scss'],
})
export class NotificationCommentNewsComponent implements OnInit {
  @Input() data: any = {};
  ...
  setResult(ev: any, data: any) {
    ...
    this.actionSheet.emit({ event, data, action: 'comment_news' });
  }
